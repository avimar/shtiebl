post({
  ...
  comments: "6.0k",
  awards: "☀️🦶🏆",
  verdict: "YTR (the kicking specifically)",
  title: "AITR for kicking my sukkah on the way out? He literally took the SUN out of its case.",
  hook: "ONE mitzvah. The easy one, they said. It hit 50°C on my roof. I left. My foot may have touched the wall. Forcefully.",
  img: "kick",
  ...
  thread: [
    ...
    },
    {
      by: "roof_neighbor",
      votes: "4.8k",
      x: `<p>I left too. Folded my chair. Said goodnight to the ushpizin. Kicked nothing.</p>`,
      flavor: true,
    },
  ],
});
