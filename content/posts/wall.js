post({
  ...
  comments: "1.9k",
  awards: "🧱🎯",
  title: "Sat under a leaning wall to save 30 seconds. Turns out that's one of three ways to make Heaven pull up YOUR file specifically.",
  hook: "Rabbi Yitzchak has a list of three things that call attention to your sins. I did all three before lunch. During the Ten Days.",
  img: "wall",
  body: `<p>Rabbi Yitzchak: three things bring a person's sins to mind: <b>a leaning wall</b>, <b>expecting your prayer to be answered</b>, and <b>handing your friend over to Heaven's judgment</b>.</p>`,
  ...
  thread: [
    {
      by: "study_hall_wall",
      votes: "22k",
      x: `<p>I lean <b>out of respect</b>. That is not an invitation to sit under me.</p>`,
      img: "c_wall",
      flavor: true,
    },
    {
      ...
      replies: [
        {
          ...
          votes: "1.4k",
          x: `<p>so if I DON'T concentrate I'm safe? 🤔</p>`,
          flavor: true,
          replies: [
            {
              by: "Tosafos",
        ...
        },
        {
          by: "both_is_good",
          votes: "2.2k",
          x: `<p>Daven with kavanah AND don't sit there waiting for a receipt. Why not both.</p>`,
          img: "c_receipt",
          flavor: true,
        },
      ],
      ...
      replies: [
        {
          ...
          votes: "388",
          x: `<p>asking for a friend: what if the other guy really, really deserves it</p>`,
          flavor: true,
          replies: [
            {
              by: "R_Zeira",
              votes: "4.2k",
              x: `<p>Walk past his house a few times. Make it easy for him to come apologize. Leave the judging upstairs.</p>`,
              flavor: true,
            },
          ],
        },
